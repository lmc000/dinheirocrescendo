...
const CORRETORAS = [
    {
        nome: "DEGIRO",
        tag: "⭐ Mais popular",
        descricao: "A corretora mais usada em Portugal. ETFs europeus gratuitos, interface simples e regulada pela CMVM.",
        rating: 4.8,
        destaque: ["ETFs gratuitos", "Regulada na UE", "App intuitiva"],
    ...
    },
    {
        nome: "Trading 212",
        tag: "🆓 Sem comissões",
        descricao: "Zero comissões em ações e ETFs. Fractional shares a partir de 1€. Ideal para começar.",
        rating: 4.6,
        destaque: ["0€ comissões", "Fractional shares", "Conta ISA"],
    ...
    },
    {
        nome: "XTB",
        tag: "🏆 Melhor suporte",
        descricao: "Plataforma profissional com suporte em português. Ótima para quem quer acompanhamento.",
        rating: 4.7,
        destaque: ["Suporte PT", "xStation 5", "Sem dep. mínimo"],
